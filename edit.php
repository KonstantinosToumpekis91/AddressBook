...
if (mysqli_num_rows($result)>0){
    ...
    $alertMessage = "<div class='alert alert-warning'>Nothing to see here!
        <a href='clients.php'>Head Back</a></div>";
}
...
if(isset($_POST['update'])){
    ...
    $query = "UPDATE clients SET name='$clientName',
    email='$clientEmail', phone='$clientPhone', address='$clientAddress',
...
if(isset($_POST['delete'])){
    ...
    <form action='". htmlspecialchars($_SERVER['PHP_SERF']) . "?id=$clientID' method='post'>
...
if(isset($_POST['confirm-delete'])){
    ...
    if($result){
        ...
        echo "Error updating recod" . mysqli_error($conn);
    }
